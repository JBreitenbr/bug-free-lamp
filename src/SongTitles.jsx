...
return (<div><ol>{songs1.map((track)=><li className="text-wrap">{track+")"}</li>)}</ol></div>)/*<div className="text-wrap flex"><ol className="ml-4" start={med+songs.length%2+1}>{songs2.map((track)=><li className="text-wrap">{track+")"}</li>)}</ol></div>);*/
}
